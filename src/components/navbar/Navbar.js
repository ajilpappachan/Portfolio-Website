    ...
    return (<div>
        <nav className="db dt-l w-100 border-box pa3 ph5-l bg-black o-90">
            ...
            <div className="db dtc-l v-mid w-100 w-75-l tc tr-l">
                <a className="link dim white f6 f5-l dib mr3 mr4-l pointer">Programming</a>
                <a className="link dim white f6 f5-l dib mr3 mr4-l pointer">Game Development</a>
                <a className="link dim white f6 f5-l dib mr3 mr4-l pointer">3D Modelling</a>
                <a className="link dim white f6 f5-l dib mr3 mr4-l pointer">Film Making</a>
            </div>
        </nav>
    </div>);
}
